...
The next plot that it was necessary to generate was the plot of the proportion of homozygous and heterozygous sites and missing data in each species and each group. To do this, I
```{r}
